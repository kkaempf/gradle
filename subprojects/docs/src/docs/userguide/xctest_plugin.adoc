...
====
include::sample[dir="userguide/swift/swiftXCTest/groovy",files="build.gradle[tags=apply-plugin]"]
include::sample[dir="userguide/swift/swiftXCTest/kotlin",files="build.gradle.kts[tags=apply-plugin]"]
====
...
====
include::sample[dir="userguide/swift/swiftXCTest/groovy",files="build.gradle[tags=configure-target-machines]"]
include::sample[dir="userguide/swift/swiftXCTest/kotlin",files="build.gradle.kts[tags=configure-target-machines]"]
====
...
// TODO:
//You <<building_cpp_projects.adoc#sec:custom_cpp_source_set_paths,configure the project layout>> by configuring the `source` on the `xctest` script block.
...
link:{groovyDslPath}/org.gradle.language.swift.tasks.SwiftCompile.html#org.gradle.language.swift.tasks.SwiftCompile:toolChain[toolChain]:: <<building_cpp_projects.adoc#cpp_supported_tool_chain,automatically selected based on target machine>>
...
link:{groovyDslPath}/org.gradle.nativeplatform.tasks.LinkMachOBundle.html#org.gradle.nativeplatform.tasks.LinkMachOBundle:toolChain[toolChain]:: <<building_cpp_projects.adoc#cpp_supported_tool_chain,automatically selected based on target machine>>
